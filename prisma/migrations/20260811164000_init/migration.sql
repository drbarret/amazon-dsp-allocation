...
-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('DRIVER', 'SUPERVISOR', 'ACCOUNT_MANAGER');
...
-- CreateEnum
CREATE TYPE "VehicleType" AS ENUM ('CARGO_VAN', 'PASSEIO');
...
-- CreateEnum
CREATE TYPE "AuditEventType" AS ENUM ('LOGIN', 'LOGOUT', 'AVAILABILITY_SUBMITTED', 'AVAILABILITY_UPDATED', 'VACANCY_PUBLISHED', 'VACANCY_UPDATED', 'ALLOCATION_RUN', 'SCHEDULE_CREATED', 'SCHEDULE_UPDATED', 'SCHEDULE_PUBLISHED', 'WHATSAPP_SENT', 'SCORECARD_IMPORTED', 'BEHAVIOR_RECORD_CREATED', 'BEHAVIOR_RECORD_UPDATED', 'MANUAL_OVERRIDE', 'CONSENT_GIVEN', 'CONSENT_REVOKED');
